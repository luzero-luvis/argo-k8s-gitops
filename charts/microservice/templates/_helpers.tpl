...
{{/* Keep the -preview suffix within the 63-character Service name limit. */}}
{{- define "charts.previewServiceName" -}}
{{- printf "%s-preview" (include "charts.fullname" . | trunc 55 | trimSuffix "-") | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* Names for the generated pre-promotion gate resources. */}}
{{- define "charts.analysisTemplateName" -}}
{{- printf "%s-gate" (include "charts.fullname" . | trunc 58 | trimSuffix "-") | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "charts.k6ConfigMapName" -}}
{{- printf "%s-k6" (include "charts.fullname" . | trunc 60 | trimSuffix "-") | trunc 63 | trimSuffix "-" -}}
{{- end -}}
